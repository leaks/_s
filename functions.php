...
if ( ! function_exists( 'sophstertoaster2013_setup' ) ) :
/**
 ...
 */
function sophstertoaster2013_setup() {

	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on _s, use a find and replace
	 * to change 'sophstertoaster2013' to the name of your theme in all the template files
	 */
	load_theme_textdomain( 'sophstertoaster2013', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'sophstertoaster2013' ),
	) );
...
add_action( 'after_setup_theme', 'sophstertoaster2013_setup' );

/**
 * Register widgetized area and update sidebar with default widgets.
 */
function sophstertoaster2013_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Sidebar', 'sophstertoaster2013' ),
		'id'            => 'sidebar-1',
...
add_action( 'widgets_init', 'sophstertoaster2013_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function sophstertoaster2013_scripts() {
	wp_enqueue_style( 'sophstertoaster2013-style', get_stylesheet_uri() );
...
add_action( 'wp_enqueue_scripts', 'sophstertoaster2013_scripts' );
